...
PARAM_DEFINE PARAM_FUTILITY_MARGIN_ALPHA1 = 300;
...
PARAM_DEFINE PARAM_FUTILITY_MARGIN_QUIET = 160;
...
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_DEPTH = 5;

// 親nodeでのfutility margin
// 元の値 = 283
// [PARAM] min:100,max:300,step:5,interval:1,time_rate:1,fixed
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_MARGIN1 = 300;
...
PARAM_DEFINE PARAM_NULL_MOVE_RETURN_DEPTH = 4;
...
PARAM_DEFINE PARAM_PROBCUT_DEPTH = 10;
...
PARAM_DEFINE PARAM_SINGULAR_EXTENSION_DEPTH = 13;
