...
std::string pretty(File f) { return pretty_jp ? std::string("１２３４５６").substr((size_t)f * 2, 2) : std::to_string((size_t)f + 1); }
std::string pretty(Rank r) { return pretty_jp ? std::string("一二三四五六").substr((size_t)r * 2, 2) : std::to_string((size_t)r + 1); }
